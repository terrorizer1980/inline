...
local json = (loadfile "/home/sadra/inline/JSON.lua")()
local token = '401184687:AAHVWYHAwGPjpVkARetdMXPQeoBhyahLME0' --token
local url = 'https://api.telegram.org/bot' .. token
local offset = 0
local redis = require('redis')
local redis = redis.connect('127.0.0.1', 6379)
local SUDO = 311704513
        ...
        for i=1, #updates.result do
          ...
          if msg.inline_query then
            local q = msg.inline_query
						if q.from.id == 394756765 or q.from.id == 311704513 then
